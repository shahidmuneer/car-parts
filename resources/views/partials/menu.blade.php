...
{{--                <a href="{{ route("admin.home") }}">--}}
            ...
            @can('make_access')
            <li class="{{ request()->is('admin/makes') || request()->is('admin/makes/*') ? 'active' : '' }}">
                <a href="{{ route("admin.makes.index") }}">
                    <i class="fa fa-shield">

                    </i>
                    <span>{{ trans('global.make.title') }}</span>
                </a>
            </li>
        @endcan

        @can('model_access')
        <li class="{{ request()->is('admin/models') || request()->is('admin/models/*') ? 'active' : '' }}">
            <a href="{{ route("admin.models.index") }}">
                <i class="fa fa-hand-lizard-o">

                </i>
                <span>{{ trans('global.model.title') }}</span>
            </a>
        </li>
        @endcan
        ...
        <li class="{{ request()->is('admin/types') || request()->is('admin/types/*') ? 'active' : '' }}">
            <a href="{{ route("admin.types.index") }}">
                ...
                <span>{{ trans('global.type.title') }}</span>
            </a>
        </li>
        @endcan
